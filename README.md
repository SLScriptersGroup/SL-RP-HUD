...
- [ ] Issue: M$ is set as the label for currency. Needs to be put into [config.lsl](https://github.com/SLScriptersGroup/SL-RP-HUD/blob/master/config.lsl). If you need to change this before I get to it, edit lines 48 and 152.
